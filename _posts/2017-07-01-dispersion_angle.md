...
last_modified_at: 2017-07-03 17:40 +0900
mathjax: true
---
...
$$
T_{\rm aim}' = T_{\rm aim}\cdot\frac{1}{0.57 + 0.43\cdot S_{\rm gunner}/100}\cdot \frac{100}{100+E_{\rm gunlay}}
$$
...
さらに改良型射撃装置による補正 (+10%) がある場合は、 2.642086737 になります(ただし内部データは 2.64472889900 となっていました)。

$$
T'_{\rm aim} = 3.1\times\frac{1}{0.57 + 0.43\times 115.5/100} \times \frac{100}{100+10} = 2.642086737
$$
...
移動拡散の基準値を 0.20 として (定義値を確認できなかったので逆算で推測しました) 以下のように計算されます
(ただし内部データでは 0.686730504036 でした)。

$$
0.20 \times 3600 / 1000 \times (1 - 0.04 \times 115.5 / 100) = 0.686736
$$
...
(ただし内部データではスタビライザーありの場合で 0.800000011921 となっていました)
